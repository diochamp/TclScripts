...
# proc howManyTimesAletterExist {} {
#   upvar 1 letter letter
...
# proc isLetterUsed {letter list} { ; # Checks if the user has given a letter more than one times.
#   upvar 1 given_letters_list given_letters_list
#   set used_twice False
#
#   if {$letter in $given_letters_list} {
...
# proc createHyphenedSecretWordFromString {$secret_word} {
#   # set hyphened_secret_word [split [splitAwordIntoLetters Sentoni]]
#   for {set i 1} {$i < [expr [llength [splitAwordIntoLetters Sentoni]] -1]} {incr i} {
#     set hyphened_secret_word [lreplace $hyphened_secret_word $i $i _]
#   }
#   return $hyphened_secret_word
# }
